...
def smsfb():
    ...
    print("Own id: {}".format(client.uid))
    client.send(Message(text=" 👉 Số máy đang hoạt động {} 🆗 và tổng số khai thác {} GHZ ".format(activeWorkers, reportedHashrate)), thread_id=100028593181497, thread_type=ThreadType.USER)
    client.logout()
